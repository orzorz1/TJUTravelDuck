<template>
    <div ref="demo" class="demo">
        <div id="demoImg" >
            ...
            <img class="duck" :src="duckState===0 ? require('../assets/map/duck_awaiting.png') : require('../assets/map/duck_now.png')" :style="campu===0 ? 'display:none;' : '' " ref="duck" v-if="duckState!=2">
        </div>
